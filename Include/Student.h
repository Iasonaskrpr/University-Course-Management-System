...
class Student : public Person{
        ...
        std::unordered_map<std::string,Grades> PassedCourses;//the map contains the courses that the student passed with the grade
        std::vector<Course*> Courses; //the vector contains  the courses that the student enrolled 
    ...
    public:
        ...
        std::vector<Course*> GetSubjects(void)const;//returns the vector with courses he enrolled
